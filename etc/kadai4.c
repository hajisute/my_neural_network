...
{ 
    ...
    for(int sample = 0; sample < K; sample++){
        ...
        for(int epoch = 0; epoch < num_epoch; epoch++){
            ...
            printf("epoch %d ,train_overall_err:%lf, train_acc: %lf\n",epoch,train_overall_err,train_acc/(double)NUM_TRAIN_DATA );        
        }
    ...
    //----------------------テストデータで学習を評価--------------------------------
        ...
        //print detail
        printf("sample :%d, test_overall_err:%lf, test_acc: %lf\n",sample,test_overall_err[sample],test_acc[sample]/(double)NUM_TEST_DATA );        
    }
